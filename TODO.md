...
- [ ] **Uklanjanje/biranje ispitnih termina** — kada postoji jun i jul rok za isti predmet, student bira kada polaže, tu pomaze AI, on ce mu dati predloge kako je najbolje organizovati se; sakriveni termini se ne prikazuju
- [ ] **AI prijedlog rasporeda polaganja** — na osnovu datuma svih ispita predlaže optimalan redosled (minimizuje kolizije, ostavlja dovoljno vremena za pripremu)

    ...
    <main className="min-h-screen bg-gray-50">
      <div className="max-w-lg mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-xl font-semibold text-gray-900">Preneseni predmeti</h1>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6 space-y-5">
            ...
            <div>
              ...
              <div className="space-y-1">
                {extraTermini.map((e, i) => (
                  <div
                    key={i}
                    className="flex items-center gap-3 py-2 px-3 bg-gray-50
                  ...
                  <div className="space-y-1 max-h-48 overflow-y-auto">
                    {terminiPredavanja.map((e, i) => (
                      ...
                      >
                        ...
                        />
                        <span className={`text-xs flex-1 ${odabranoPredavanje === e ? 'text-white' : 'text-gray-600'}`}>
                    ...
                    {terminiVezbi.map((e, i) => (
                      ...
                      >
                        <input
                          ...
                          className="flex-shrink-0"
                        />
                        <span className={`text-xs flex-1 ${odabraneVezbe === e ? 'text-white' : 'text-gray-600'}`}>
                          <span className="font-medium">{e.day}</span>
                          {' '}{SLOT_LABEL[e.start]} [{e.type_short}] · Sala {e.room}
                        </span>
                      </label>
          ...
          {preporuka && (
            <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
              <p className="text-xs font-medium text-gray-500 mb-2">AI preporuka</p>
              <div className="text-sm text-gray-900 leading-relaxed space-y-2">
                {preporuka.split('\n').map((line, i) => (
                  <p key={i} className={line.startsWith('Razlog:') ? 'text-gray-500 text-xs pt-1 border-t border-gray-100' : 'font-medium'}>
                    {line}
                  </p>
                ))}
              </div>

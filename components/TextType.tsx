...
const TextType = ({
  ...
  // JSX umesto createElement-a: `react-hooks/refs` prijavljuje prosleđivanje
  // ref-a kroz poziv funkcije (može da ga pročita tokom rendera). Rezultat je
  // identičan, samo ga lint pravilo razume.
  return (
    <Component
      ref={containerRef}
